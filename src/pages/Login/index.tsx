    ...
    <div>
      <div className="flex flex-col justify-center items-center bg-upperImage bg-no-repeat bg-cover bg-top">
        ...
        <p className="text-center">
          Melhorar a qualidade e expectativa de vida e a experiência de pessoas
          LGBTQIAP+ é o principal objetivo do Lacrei. Por isso, buscamos
          profissionais preparados para atender com segurança e qualidade na
          nossa plataforma. Venha fazer parte!
        </p>
        <Button
